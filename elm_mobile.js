...
}var $author$project$Mobile$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Mobile$UrlChanged = function (a) {
...
var $author$project$Mobile$Home = {$: 'Home'};
var $author$project$Mobile$Model = F4(
	function (key, url, page, menu) {
		return {key: key, menu: menu, page: page, url: url};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Mobile$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A4($author$project$Mobile$Model, key, url, $author$project$Mobile$Home, false),
			$elm$core$Platform$Cmd$none);
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Mobile$subscriptions = function (_v0) {
...
var $author$project$Mobile$Art = {$: 'Art'};
var $author$project$Mobile$Code = {$: 'Code'};
var $author$project$Mobile$Music = {$: 'Music'};
...
var $author$project$Mobile$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Mobile$Home,
			$elm$url$Url$Parser$s('home')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Mobile$Code,
			$elm$url$Url$Parser$s('code')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Mobile$Art,
			$elm$url$Url$Parser$s('art')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Mobile$Music,
			$elm$url$Url$Parser$s('music'))
		]));
var $author$project$Mobile$changeUrl = F2(
	function (url, model) {
		var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Mobile$routeParser, url);
		if (_v0.$ === 'Just') {
			var answer = _v0.a;
			return _Utils_Tuple2(
				_Utils_update(
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{page: $author$project$Mobile$Home}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $elm$core$Basics$not = _Basics_not;
var $author$project$Mobile$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'LinkClicked':
				...
				if (urlRequest.$ === 'Internal') {
					...
					return A2($author$project$Mobile$changeUrl, url, model);
				} else {
...
var $author$project$Mobile$MidnightGreen = {$: 'MidnightGreen'};
var $author$project$Mobile$RGBA = F4(
...
var $author$project$Mobile$viewLink = F3(
...
var $author$project$Mobile$mobileMenu = function (model) {
	return model.menu ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$MobilePage$Art$imageRender = function (imgProps) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href(imgProps.instagramUrl)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'background', 'url(' + ('https://raw.githubusercontent.com/apuravkhare/akhare/refs/heads/main/images/' + (imgProps.srcUrl + ') center / cover'))),
...
var $author$project$MobilePage$Art$imagesToEmbed = _List_fromArray(
	[
...
var $author$project$MobilePage$Art$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$MobilePage$Art$imageRender, $author$project$MobilePage$Art$imagesToEmbed));
};
var $author$project$MobilePage$Code$codeItem = function (child) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$MobilePage$Code$codewars = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$MobilePage$Code$personalSite = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'text-align', 'left')
...
var $author$project$MobilePage$Code$separator = A2(
	...
	_List_Nil);
var $author$project$MobilePage$Code$thesis = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$MobilePage$Code$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$MobilePage$Code$codeItem($author$project$MobilePage$Code$personalSite),
				$author$project$MobilePage$Code$separator,
				$author$project$MobilePage$Code$codeItem($author$project$MobilePage$Code$thesis),
				$author$project$MobilePage$Code$separator,
				$author$project$MobilePage$Code$codeItem($author$project$MobilePage$Code$codewars)
			]));
};
var $author$project$MobilePage$Home$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$MobilePage$Music$createEmbed = function (url) {
...
var $author$project$MobilePage$Music$videosToEmbed = _List_fromArray(
	['Y1LkX5tLHX0', 'WPG8E6i1ETg', 'M0Xw676YueM', 'ep-hHNUR0Ls', 'WmBuwMcmi9A']);
var $author$project$MobilePage$Music$videos = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'display', 'flex'),
	...
	A2($elm$core$List$map, $author$project$MobilePage$Music$createEmbed, $author$project$MobilePage$Music$videosToEmbed));
var $author$project$MobilePage$Music$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[$author$project$MobilePage$Music$videos]));
};
var $author$project$Mobile$renderTab = function (model) {
	var _v0 = model.page;
	switch (_v0.$) {
		case 'Home':
			return $author$project$MobilePage$Home$view(
				_Utils_update(
					model,
					{menu: false}));
		case 'Code':
			return $author$project$MobilePage$Code$view(
				_Utils_update(
					model,
					{menu: false}));
		case 'Art':
			return $author$project$MobilePage$Art$view(
				_Utils_update(
					model,
					{menu: false}));
		default:
			return $author$project$MobilePage$Music$view(
				_Utils_update(
					model,
					{menu: false}));
	}
...
var $author$project$Mobile$view = function (model) {
	return {
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Mobile$mobileMenu(model),
						$author$project$Mobile$renderTab(model),
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												20,
												A4($author$project$Mobile$RGBA, 0.36, 0.37, 0.38, 1))
											])),
										A2(
										$elm$html$Html$a,
										_List_fromArray(
...
var $author$project$Mobile$main = $elm$browser$Browser$application(
	{init: $author$project$Mobile$init, onUrlChange: $author$project$Mobile$UrlChanged, onUrlRequest: $author$project$Mobile$LinkClicked, subscriptions: $author$project$Mobile$subscriptions, update: $author$project$Mobile$update, view: $author$project$Mobile$view});
_Platform_export({'Mobile':{'init':$author$project$Mobile$main(
